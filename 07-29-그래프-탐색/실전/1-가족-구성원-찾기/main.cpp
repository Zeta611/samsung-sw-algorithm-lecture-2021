...
extern bool addMember(char newMemberName[], int newMemberSex, int relationship,
...
static void cmd_addMember()
{
    ...
    scanf("%s %d %d %s", newMemberName, &newMemberSex, &relationship,
          existingMemberName);

    bool userAns = addMember(newMemberName, newMemberSex, relationship,
                             existingMemberName);
